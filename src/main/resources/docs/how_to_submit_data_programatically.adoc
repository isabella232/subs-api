...
== Authorization amd authentication
...
==== Example request
 ...
 $ curl 'http://localhost:8080/domains' -i -X POST -H 'Content-Type: application/json;charset=UTF-8' -H 'Authorization: Bearer <your_aap_token>' -H 'Accept: application/hal+json' -d '{"domainName":"new domain","domainDesc":"new domain Desc"}'
...

{
  ...
  "_links" : {
    "self" : {
      "href" : "http://localhost:8080/domains/dom-de00a819-dfe4-4516-8ad8-0c8d571e162d"
    },
    "deactivate" : {
      "href" : "http://localhost:8080/domains/dom-de00a819-dfe4-4516-8ad8-0c8d571e162d"
    },
    "get users from domain" : {
      "href" : "http://localhost:8080/domains/dom-de00a819-dfe4-4516-8ad8-0c8d571e162d/users"
    },
    "admin" : {
      "href" : "http://localhost:8080/domains/dom-eb5bd028-a4aa-45b9-9457-7c375b55d1b3"
    },
    "get all domains" : {
      "href" : "http://localhost:8080/domains"
    }
  }
}
....
...
==== Example request
 ...
 $ curl 'http://localhost:8080/domains/<your_domain_reference>/<your_user_reference>/user' -i -X PUT -H 'Authorization: Bearer <your_aap_token>' -H 'Accept: application/hal+json'
...

{
  ...
  "users" : [ {
    ...
    "_links" : {
      "self" : {
        "href" : "http://localhost:8080/users/usr-d8749acf-6a22-4438-accc-cc8d1877ba36"
      }
    }
  }, {
    ...
    "_links" : {
      "self" : {
        "href" : "http://localhost:8080/users/usr-9832620d-ec53-43a1-873d-efdc50d34ad1"
      }
    }
  } ],
  "managers" : null,
  "_links" : {
    "self" : {
      "href" : "http://localhost:8080/domains/dom-36ccaae5-1ce1-41f9-b65c-d349994e9c80"
    },
    "deactivate" : {
      "href" : "http://localhost:8080/domains/dom-36ccaae5-1ce1-41f9-b65c-d349994e9c80"
    },
    "get users from domain" : {
      "href" : "http://localhost:8080/domains/dom-36ccaae5-1ce1-41f9-b65c-d349994e9c80/users"
    },
    "admin" : {
      "href" : "http://localhost:8080/domains/dom-7c3aa7d3-e9bc-43e5-818a-8971390a3102"
    },
    "get all domains" : {
      "href" : "http://localhost:8080/domains"
    }
...
Using the link labelled `submissions:create`, `POST` a document containing a submitter to create
a submission:
