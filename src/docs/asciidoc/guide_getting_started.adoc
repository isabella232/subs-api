...
include::{snippets}/create-sample-proxy/curl-request.adoc[]

This will return a response to show that the sample record has been created, with links to other

include::{snippets}/create-sample-real/http-response.adoc[]
...
include::{snippets}/create-project-proxy/curl-request.adoc[]

This will return a response to show that the project record has been created:

include::{snippets}/create-project-real/http-response.adoc[]
...
include::{snippets}/create-study-proxy/curl-request.adoc[]

This will return a response to show that the study record has been created:

include::{snippets}/create-study-real/http-response.adoc[]
...
include::{snippets}/create-assay-proxy/curl-request.adoc[]

This will return a response to show that the assay record has been created:

include::{snippets}/create-assay-real/http-response.adoc[]
...
include::{snippets}/create-assay-data-proxy/curl-request.adoc[]

This will return a response to show that the assay record has been created:

include::{snippets}/create-assay-data-real/http-response.adoc[]
