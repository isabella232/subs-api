...
https://en.wikipedia.org/wiki/JSON[JSON document], with one field:

 * `description` - a description of your team

Creating a team will automatically make you a manager of that team, so you can add and remove people from it.
...
rather than the main server, please use this version of AAP: https://explore.aai.ebi.ac.uk
