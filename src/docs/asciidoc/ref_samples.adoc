...
"submission": {
    ...
    "properties": {
        ...
        "identifier": {
            "type": "string",
            "description": "Assigned by BioSamples Database",
            "readOnly": "true"
        },
        "description": {
            "type": "string",
        ...
        "version": {
            "type": "string",
            "description": "Version of SampleTab specification (currently 1.2)"
        },
        "referenceLayer": {
            "type": "boolean",
            "description": "If this submission is part of the reference layer, this will be 'true'. Otherwise it will be 'false'.",
            "readOnly": "true"
        },
        "updateDate": {
            "type": "string",
